...
public class TestFunctionTask1_5Test {
     ...
     *          возвращает -1 если передано ненатуральное число
     */
    ...
    public static double checkRandomGenerator(int value) {
        ...
        int currentLoop = 0;
        while (value > currentLoop) {                          // ? можно ли использовать константы в методах или передовать на вход?
     ...
     *  @param number - натуральное число
     *  @return возвращает сумму четных цифр числа
     */
    ...
    /** Метод нахождения количества четных цифр числа
     *  @param number - натуральное число
     *  @return возвращает сумму нечетных цифр числа
     */
