...
import home_work_4.ComparatorForStringForValue;
...
public class DataContainerStringMain {
    public static void main(String[] args) {
        ...
        System.out.println("После сортировки элементов по длине " + container);

        ComparatorForStringForValue comparatorForValue = new ComparatorForStringForValue();
